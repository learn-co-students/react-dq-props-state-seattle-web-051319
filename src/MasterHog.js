    ...
    return (
      <div>
        ...
        <ul className="hoglist">
          <BabyHog babyInfo={offspring[0]} eyeColor={this.state.eyeColor}/>
          <BabyHog babyInfo={offspring[1]} eyeColor={this.state.eyeColor}/>
          <BabyHog babyInfo={offspring[2]} eyeColor={this.state.eyeColor}/>
        </ul>
